                ...
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid d-flex">
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown me-1">
                                    ...
                                    <ul class="dropdown-menu mt-2">
                                        <li><a class="dropdown-item" href="change-layout/signin">Đăng nhập</a></li>
                                        <li><a class="dropdown-item" href="change-layout/forgot">Quên mật mật khẩu</a></li>
                                        <li><a class="dropdown-item" href="change-layout/signup">Đăng ký thành viên</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="change-layout/signout">Đăng xuất</a></li>
                                        <li><a class="dropdown-item" href="change-layout/changep">Đổi mật khẩu</a></li>
                                        <li><a class="dropdown-item" href="change-layout/profile">Cập nhật hồ sơ</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="change-layout/favorites">My Favorites</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="btn-group col-lg-2">
                            ...
                            <a href="?lang=vi" class="btn btn-dark active">Tiếng việt</a>
                        </div>
                    </div>
                </nav>
            </nav>
